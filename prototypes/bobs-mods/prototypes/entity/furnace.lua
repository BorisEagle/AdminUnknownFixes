data.raw.furnace["bob-electric-furnace-2"].energy_usage = "15MW"
data.raw.furnace["bob-electric-furnace-2"].crafting_speed = 12
data.raw.furnace["bob-electric-furnace-2"].energy_source = {
    type = "heat",
...
data.raw.furnace["bob-electric-furnace-3"].energy_usage = "20MW"
data.raw.furnace["bob-electric-furnace-3"].crafting_speed = 16
data.raw.furnace["bob-electric-furnace-3"].energy_source = {
    type = "heat",
    max_temperature = 1000,
    specific_heat = "1MJ",
    max_transfer = "2GW",
