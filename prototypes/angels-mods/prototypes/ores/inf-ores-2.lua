if mods['pyalternativeenergy'] and not mods['SeaBlock'] then
	...
	data.raw.resource['infinite-ore-aluminium'].minable.required_fluid = 'angels-gas-synthesis'
	data.raw.resource['infinite-ore-chromium'].minable.required_fluid = 'refsyngas'
	data.raw.resource['infinite-ore-quartz'].minable.required_fluid = 'angels-gas-synthesis'
